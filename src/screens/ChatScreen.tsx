...
const QUICK_QUESTIONS = [
  ...
  "Як зареєструвати вхідний документ?",
  "Як викликати кур'єра Нової Пошти?",
  "Як створити заявку на перепустку в Creatio?",
  "Що робити після відправки листа Укрпоштою?",
  "Як оформити заявку на внесення/винесення?",
];
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      role: "assistant",
      content:
        "👋 Привіт! Я корпоративний асистент.\n\nМожу допомогти з:\n• 🔴 Нова Пошта\n• ✉️ Укрпошта\n• 🟡 DHL Express\n• 📁 Вхідна/Вихідна кореспонденція\n• 🪪 Перепустки та Внесення/Винесення\n\nЗадай питання або обери одне з поширених нижче.",
